...
item = new Item();
item.name = "Keris partisan";
item.style = AttackStyle.Stab;
item.imagePath = './Images/Items/Keris_partisan.png';
item.wikiLink = "https://oldschool.runescape.wiki/w/Keris_partisan";
item.slot = Slot.MainHand;
item.speedSeconds = 2.4;
item.stab = 58;
item.slash = -2;
...
item = new Item();
item.name = "Keris partisan of corruption";
item.style = AttackStyle.Stab;
item.imagePath = './Images/Items/Keris_partisan_of_corruption.png';
item.wikiLink = "https://oldschool.runescape.wiki/w/Keris_partisan_of_corruption";
item.slot = Slot.MainHand;
item.speedSeconds = 2.4;
item.stab = 58;
item.slash = -2;
...
item = new Item();
item.name = "Keris partisan of the sun";
item.style = AttackStyle.Stab;
item.imagePath = './Images/Items/Keris_partisan_of_the_sun.png';
item.wikiLink = "https://oldschool.runescape.wiki/w/Keris_partisan_of_the_sun";
item.slot = Slot.MainHand;
item.speedSeconds = 2.4;
item.stab = 58;
item.slash = -2;
...
item = new Item();
item.name = "Keris partisan of breaching";
item.style = AttackStyle.Stab;
item.imagePath = './Images/Items/Keris_partisan_of_breaching.png';
item.wikiLink = "https://oldschool.runescape.wiki/w/Keris_partisan_of_breaching";
item.slot = Slot.MainHand;
item.speedSeconds = 2.4;
item.stab = 58;
item.slash = -2;
