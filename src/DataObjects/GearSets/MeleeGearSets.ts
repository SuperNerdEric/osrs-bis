...
export function generateMeleeGearSets(){
    ...
    const weaponsWithStyles: { name: ItemName, styles: CombatStyle[], gearSetType: GearSetType }[] = [
        ...
        { name: ItemName.LeafBladedSpear, styles: [CombatStyle.Lunge, CombatStyle.Swipe, CombatStyle.Pound], gearSetType: GearSetType.General },
        { name: ItemName.LeafBladedSword, styles: [CombatStyle.Stab, CombatStyle.Lunge, CombatStyle.Slash], gearSetType: GearSetType.General },
        { name: ItemName.LeafBladedBattleaxe, styles: [CombatStyle.Chop, CombatStyle.Hack, CombatStyle.Smash], gearSetType: GearSetType.General },
