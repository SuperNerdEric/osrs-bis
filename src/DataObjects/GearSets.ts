...
export function createGearSet(itemNames: string[]): Item[] {
...
gearSets.push(createGearSet(["Osmumten's fang", "Avernic defender", "Slayer helmet (i)", "Torva platebody", "Torva platelegs", "Ferocious gloves", "Primordial boots", "Amulet of torture", "Infernal cape"]));
...
gearSets.push(createGearSet(["Twisted bow", "Dragon arrow", "Slayer helmet (i)", "Masori body (f)", "Masori chaps (f)", "Zaryte vambraces", "Necklace of anguish", "Ava's assembler"]));
...
gearSets.push(createGearSet(["Tumeken's shadow", "Slayer helmet (i)", "Ancestral robe top", "Ancestral robe bottom", "Tormented bracelet", "Occult necklace", "Imbued zamorak cape"]));
